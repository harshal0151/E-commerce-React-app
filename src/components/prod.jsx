 ...
 <div className="col mb-5">
            ...
            <img src={image} className="card-img-top img-fluid" alt="..." />
              ...
              <p className="card-text mb-2">{brand}</p>
                ...
                <p className="d-flex justify-content-center"><button className='myButton'>View Details</button></p>
                </Link>
                </div>
               ...
               <button 
                  ...
                  className="myButton"> Add To Cart {cartItemAmount > 0 && `(${cartItemAmount})`}
                </button>
